...
public class PersonaRepositorio extends BaseRepository<Persona>{
	...
	@Override
	public int Insert(Connection conexion, String tabla, Persona data) {
		String query = "INSERT INTO " + tabla + " (nombre, direccion, telefono, email, tipo) VALUES ('"+
				data.getNombre() + 
				"', '" + 
				data.getDireccion() + 
				"', '" + 
	...
	@Override
	public int Update(Connection conexion, String tabla, Persona data, int id) {
	...
	public ResultSet GetByName(Connection conexion, String tabla, String name, String type) {
		String query = "SELECT * FROM " + tabla + " WHERE tipo = '"+ type +"' AND nombre LIKE '%" + name + "%'";
		Statement stmt;
		ResultSet result;
		try {
			stmt = conexion.createStatement();
	...
	public ResultSet GetAll(Connection conexion, String tabla, String type) {
		String query = "SELECT * FROM " + tabla + " WHERE tipo = '"+ type +"'";
		Statement stmt;
		ResultSet result;
